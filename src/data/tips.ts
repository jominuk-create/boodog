...
export const INITIAL_TIPS: Tip[] = [
  // --- [NEW] 고효율 실용 노하우 20선 ---
  { 
    id: 101, category: 'kitchen', title: '반찬통 배달용기 기름기 제거', 
    content: '주방세제 대신 설탕 한 스푼을 넣고 흔들어보세요.',
    details: '플라스틱 용기에 밴 붉은 기름기는 세제만으로는 잘 안 닦입니다. 설탕의 흡착 성질을 이용하면 완벽하게 제거됩니다.',
    steps: ['용기에 따뜻한 물을 조금 담고 설탕 1큰술을 넣습니다.', '주방세제를 한 번 펌핑하고 뚜껑을 닫습니다.', '30초간 세게 흔든 뒤 헹궈내면 미끈거림이 마법처럼 사라집니다.']
  },
  { 
    id: 102, category: 'utility', title: '줄어든 니트 복구하기', 
    content: '린스를 푼 미지근한 물에 20분간 담가두세요.',
    details: '세탁 실수로 아기 옷처럼 줄어든 니트는 헤어 린스의 단백질 이완 성분으로 복구가 가능합니다.',
    steps: ['미지근한 물에 린스를 평소보다 넉넉히 풀어줍니다.', '니트를 담그고 결대로 살살 늘려가며 20분간 둡니다.', '마른 수건으로 물기를 꾹꾹 눌러 짠 뒤 그늘에서 평평하게 말립니다.']
  },
  { 
    id: 103, category: 'kitchen', title: '시든 채소 심폐소생술', 
    content: '설탕 1스푼과 식초 3방울을 넣은 물에 담그세요.',
    details: '냉장고에서 시들해진 상추나 깻잎은 삼투압 현상을 이용해 다시 싱싱하게 살릴 수 있습니다.',
    steps: ['찬물에 설탕 1스푼과 식초를 조금 넣습니다.', '시든 채소를 10~20분간 푹 담가둡니다.', '채소가 물을 흡수해 갓 산 것처럼 아삭해집니다.']
  },
  { 
    id: 104, category: 'utility', title: '흰 옷 땀자국/누런 때 제거', 
    content: '아스피린 2알을 녹인 물에 불려주세요.',
    details: '약국에서 파는 아스피린의 살리실산 성분은 찌든 땀 얼룩을 분해하는 효과가 탁월합니다.',
    steps: ['뜨거운 물에 아스피린 2~3알을 넣어 녹입니다.', '누렇게 변한 옷을 3시간 정도 푹 담가둡니다.', '가볍게 비벼준 뒤 세탁기에 돌리면 새하얗게 돌아옵니다.']
  },
  { 
    id: 105, category: 'bathroom', title: '샤워기 헤드 물때 완벽 제거', 
    content: '지퍼백에 식초 물을 담아 묶어두세요.',
    details: '샤워기 구멍이 막혀 물줄기가 갈라진다면 석회질 때가 낀 것입니다. 식초가 이를 녹여줍니다.',
    steps: ['지퍼백에 따뜻한 물과 식초를 1:1로 섞습니다.', '샤워기 헤드를 통째로 넣고 고무줄로 묶습니다.', '1시간 뒤 꺼내 칫솔로 문지르면 수압이 원래대로 돌아옵니다.']
  },
  { 
    id: 106, category: 'bedroom', title: '먼지 없는 매트리스 관리', 
    content: '굵은 소금을 뿌리고 문지른 뒤 청소하세요.',
    details: '매트리스 깊숙한 곳의 미세먼지와 진드기 사체는 소금의 정전기와 흡착력을 이용하면 잘 빠져나옵니다.',
    steps: ['매트리스 위에 굵은 소금을 골고루 뿌립니다.', '장갑을 끼고 소금을 문지르면 소금이 검게 변합니다.', '청소기로 소금을 깨끗이 빨아들이면 먼지 제거 완료!']
  },
  { 
    id: 107, category: 'kitchen', title: '튀김 기름 튐 방지법', 
    content: '기름에 소금을 한 꼬집 넣고 요리하세요.',
    details: '요리 중 기름이 튀는 이유는 재료의 수분 때문인데, 소금이 수분을 잡아주는 역할을 합니다.',
    steps: ['기름을 가열하기 전 소금을 한 꼬집 넣습니다.', '재료를 넣으면 평소보다 훨씬 덜 튀는 것을 느낄 수 있습니다.']
  },
  { 
    id: 108, category: 'utility', title: '테이프 끈적임 지우기', 
    content: '식용유나 안 쓰는 선크림을 발라주세요.',
    details: '스티커를 떼고 남은 끈적이는 자국은 유분으로 녹여내는 것이 가장 깔끔합니다.',
    steps: ['자국 위에 식용유나 선크림을 듬뿍 바릅니다.', '5분 정도 스며들게 둡니다.', '키친타월이나 마른 수건으로 닦아내면 매끈해집니다.']
  },
  { 
    id: 109, category: 'kitchen', title: '두부 물 없이 싱싱하게', 
    content: '먹다 남은 두부는 구워보관하세요.',
    details: '생두부를 물에 담가 보관하면 금방 상하지만, 구우면 보관 기간이 늘어납니다.',
    steps: ['남은 두부를 적당한 크기로 썰어 기름에 살짝 굽습니다.', '밀폐 용기에 담아 냉장 보관하면 3~4일 더 신선합니다.']
  },
  { 
    id: 110, category: 'bathroom', title: '변기 뚫는 초간단 방법', 
    content: '샴푸를 듬뿍 넣고 30분 뒤 내리세요.',
    details: '뚫어뻥이 없을 때 샴푸의 계면활성제 성분이 오물을 부드럽게 만들어 뚫리게 합니다.',
    steps: ['변기에 샴푸를 5~6번 펌핑하여 듬뿍 넣습니다.', '30분~1시간 정도 그대로 둡니다.', '물을 내리면 부드럽게 쑥 내려갑니다.']
  },
  { 
    id: 111, category: 'livingroom', title: '원목 가구 찍힘 복구', 
    content: '젖은 수건을 대고 다리미로 열을 가하세요.',
    details: '나무 섬유질이 수분과 열을 만나 팽창하면서 패인 부분이 올라오게 됩니다.',
    steps: ['찍힌 부위에 물을 묻힌 수건을 올립니다.', '다리미를 온도를 높여 수건 위를 30초간 누릅니다.', '나무가 다시 차오르면 건조 후 바니시나 오일을 발라 마무리합니다.']
  },
  { 
    id: 112, category: 'utility', title: '옷에 묻은 볼펜 자국 지우기', 
    content: '물파스나 헤어스프레이를 뿌리세요.',
    details: '볼펜 잉크의 유기용제 성분을 물파스의 알코올 성분이 녹여줍니다.',
    steps: ['자국 아래에 안 쓰는 천이나 휴지를 댑니다.', '물파스를 자국 위에 듬뿍 두드려 바릅니다.', '잉크가 번지듯 녹으면 세제로 가볍게 비벼 세탁합니다.']
  },
  { 
    id: 113, category: 'kitchen', title: '고기 잡내 잡는 비법', 
    content: '조리 전 설탕물에 10분만 담그세요.',
    details: '설탕은 입자가 커서 단백질 사이에 들어가 잡내를 내뿜게 하고 육질을 부드럽게 합니다.',
    steps: ['물 1리터에 설탕 2스푼을 탑니다.', '고기를 10분 정도 담가둔 뒤 핏물을 뺍니다.', '누린내가 사라지고 훨씬 연한 고기 요리가 됩니다.']
  },
  { 
    id: 114, category: 'utility', title: '건조기 정전기 완벽 방지', 
    content: '알루미늄 호일을 공처럼 말아 넣으세요.',
    details: '값비싼 건조기 시트 대신 호일 공이 전자를 흡수해 정전기를 막아줍니다.',
    steps: ['알루미늄 호일을 주먹만한 공 모양으로 3개 만듭니다.', '세탁물과 함께 건조기에 넣고 돌립니다.', '옷이 서로 달라붙지 않고 정전기가 0에 수렴합니다.']
  },
  { 
    id: 115, category: 'kitchen', title: '눅눅한 설탕/소금 살리기', 
    content: '나무 젓가락 조각이나 쌀알을 넣으세요.',
    details: '나무나 쌀알이 통 안의 습기를 대신 흡수하여 양념이 굳는 것을 방지합니다.',
    steps: ['양념통 속에 깨끗한 나무 젓가락 한 조각을 넣습니다.', '이미 굳었다면 전자레인지에 30초만 돌려 수분을 날리세요.']
  },
  { 
    id: 116, category: 'utility', title: '바닥 층간소음 방지 꿀템', 
    content: '의자 다리에 테니스공 대신 양말을 신기세요.',
    details: '테니스공은 먼지가 많이 붙고 미관상 좋지 않습니다. 두툼한 양말이 더 효과적입니다.',
    steps: ['안 쓰는 수면 양말을 의자 다리 크기에 맞게 자릅니다.', '다리에 씌우고 고무줄로 고정하면 소음과 긁힘이 완벽 차단됩니다.']
  },
  { 
    id: 117, category: 'kitchen', title: '프라이팬 코팅 수명 늘리기', 
    content: '세제 대신 부드러운 천과 기름으로 닦으세요.',
    details: '코팅 팬은 세제를 자주 쓰면 수명이 짧아집니다. 기름으로 길들이는 과정이 필요합니다.',
    steps: ['사용한 팬이 뜨거울 때 키친타월로 음식물을 닦습니다.', '물로 살짝 헹군 뒤 다시 가열해 수분을 날립니다.', '기름 한 방울을 떨어뜨려 얇게 코팅하듯 닦아 보관합니다.']
  },
  { 
    id: 118, category: 'bedroom', title: '옷걸이 자국 안 남게 걸기', 
    content: '겨드랑이 부분에 옷걸이를 대고 접으세요.',
    details: '니트나 티셔츠를 일반적인 방법으로 걸면 어깨가 뿔처럼 솟습니다. 반으로 접어 거는 것이 정석입니다.',
    steps: ['옷을 세로로 반 접습니다.', '옷걸이 고리 부분을 겨드랑이 쪽에 둡니다.', '팔 부분과 몸통 부분을 옷걸이 어깨 쪽으로 넘겨줍니다.']
  },
  { 
    id: 119, category: 'utility', title: '신발 밑창 소음/미끄럼 방지', 
    content: '밑창에 글루건으로 선을 그어주세요.',
    details: '새 신발이 미끄럽거나 삑삑 소리가 날 때 마찰력을 만들어주는 가장 쉬운 방법입니다.',
    steps: ['신발 밑창을 깨끗이 닦습니다.', '글루건을 이용해 지그재그 모양으로 얇게 선을 긋습니다.', '글루건이 완전히 굳으면 미끄럼 방지 패드 역할을 합니다.']
  },
  { 
    id: 120, category: 'livingroom', title: '벽지 곰팡이 초기 진압', 
    content: '물과 알코올을 4:1로 섞어 뿌리세요.',
    details: '곰팡이는 습기를 먹고 자랍니다. 알코올이 수분을 증발시키고 살균까지 해줍니다.',
    steps: ['분무기에 물 4, 알코올 1 비율로 섞습니다.', '곰팡이 부위에 뿌리고 10분 정도 둡니다.', '드라이기 찬바람으로 바짝 말려주면 곰팡이 확산을 막습니다.']
  },
  ...
  { id: 69, category: 'bedroom', title: '방 안 습도 조절', content: '젖은 수건을 걸어두세요.', details: '가습기 없이도 쾌적한 환경을 만듭니다.', steps: ['자기 전 수건을 적셔 옷걸이에 겁니다.'] },
